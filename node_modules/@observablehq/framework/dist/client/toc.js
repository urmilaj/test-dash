...
if (toc) {
  ...
  const headings = Array.from(document.querySelector("#observablehq-main").querySelectorAll(toc.dataset.selector)).filter((e) => e.querySelector("a.observablehq-header-anchor")).reverse();
